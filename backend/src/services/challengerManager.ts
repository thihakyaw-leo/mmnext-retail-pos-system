...
export const DIFFICULTY_LEVELS = {
    EASY: { multiplier: 1, pointsBase: 50, name: 'Dá»…' },
    MEDIUM: { multiplier: 1.5, pointsBase: 100, name: 'Trung bÃ¬nh' },
    HARD: { multiplier: 2, pointsBase: 200, name: 'KhÃ³' },
    EXTREME: { multiplier: 3, pointsBase: 500, name: 'Cá»±c khÃ³' }
};
...
const CHALLENGE_TEMPLATES = [
    // Daily challenges
    {
        ...
        title: 'Target doanh sá»‘ hÃ´m nay',
        description: 'Äáº¡t doanh sá»‘ {target} trong ngÃ y hÃ´m nay',
    ...
    },
    {
        ...
        title: 'Sá»‘ giao dá»‹ch trong ngÃ y',
        description: 'HoÃ n thÃ nh {target} giao dá»‹ch trong ngÃ y',
    ...
    },
    {
        ...
        title: 'Phá»¥c vá»¥ khÃ¡ch hÃ ng',
        description: 'Phá»¥c vá»¥ {target} khÃ¡ch hÃ ng khÃ¡c nhau trong ngÃ y',
    ...
    },
    {
        ...
        title: 'Tá»‘c Ä‘á»™ giao dá»‹ch',
        description: 'HoÃ n thÃ nh giao dá»‹ch trung bÃ¬nh dÆ°á»›i {target} giÃ¢y',
    ...
    // Weekly challenges
    {
        ...
        category: CHALLENGE_CATEGORIES.SALES,
        title: 'Doanh sá»‘ tuáº§n',
        description: 'Äáº¡t doanh sá»‘ {target} trong tuáº§n nÃ y',
    ...
    },
    {
        ...
        title: 'Hiá»‡u quáº£ lÃ m viá»‡c',
        description: 'Duy trÃ¬ hiá»‡u quáº£ trÃªn {target}% trong tuáº§n',
    ...
    },
    {
        ...
        title: 'Äá»™ chÃ­nh xÃ¡c',
        description: 'Duy trÃ¬ Ä‘á»™ chÃ­nh xÃ¡c trÃªn {target}% trong tuáº§n',
    ...
    // Monthly challenges
    {
        ...
        category: CHALLENGE_CATEGORIES.SALES,
        title: 'SiÃªu target thÃ¡ng',
        description: 'Äáº¡t doanh sá»‘ {target} trong thÃ¡ng',
    ...
    },
    {
        ...
        description: 'Thu hÃºt {target} khÃ¡ch hÃ ng má»›i trong thÃ¡ng',
...
const ACHIEVEMENT_TEMPLATES = [
    {
        id: 'FIRST_SALE',
        title: 'Giao dá»‹ch Ä‘áº§u tiÃªn',
        description: 'HoÃ n thÃ nh giao dá»‹ch bÃ¡n hÃ ng Ä‘áº§u tiÃªn',
        icon: 'ðŸŽ¯',
        category: 'milestone',
        rarity: 'common',
        points: 100,
    ...
    {
        id: 'SALES_ROOKIE',
        title: 'TÃ¢n binh bÃ¡n hÃ ng',
        description: 'HoÃ n thÃ nh 10 giao dá»‹ch bÃ¡n hÃ ng',
        icon: 'ðŸƒ',
        category: 'sales',
        rarity: 'common',
        points: 200,
    ...
    {
        id: 'SALES_WARRIOR',
        title: 'Chiáº¿n binh bÃ¡n hÃ ng',
        description: 'HoÃ n thÃ nh 100 giao dá»‹ch bÃ¡n hÃ ng',
        icon: 'âš”ï¸',
        category: 'sales',
        rarity: 'rare',
        points: 500,
    ...
    {
        id: 'SALES_LEGEND',
        title: 'Huyá»n thoáº¡i bÃ¡n hÃ ng',
        description: 'HoÃ n thÃ nh 1000 giao dá»‹ch bÃ¡n hÃ ng',
        icon: 'ðŸ‘‘',
        category: 'sales',
        rarity: 'legendary',
        points: 2000,
    ...
    {
        id: 'MILLION_SELLER',
        title: 'Triá»‡u phÃº doanh sá»‘',
        description: 'Äáº¡t doanh sá»‘ 10 triá»‡u Ä‘á»“ng trong thÃ¡ng',
        icon: 'ðŸ’°',
        category: 'revenue',
        rarity: 'epic',
        points: 1000,
    ...
    {
        id: 'CUSTOMER_LOVER',
        title: 'NgÆ°á»i yÃªu khÃ¡ch hÃ ng',
        description: 'Phá»¥c vá»¥ 500 khÃ¡ch hÃ ng khÃ¡c nhau',
        icon: 'â¤ï¸',
        category: 'customer',
        rarity: 'rare',
        points: 750,
    ...
    {
        id: 'SPEED_DEMON',
        title: 'Tháº§n tá»‘c Ä‘á»™',
        description: 'HoÃ n thÃ nh 20 giao dá»‹ch trong 1 giá»',
        icon: 'âš¡',
        category: 'speed',
        rarity: 'epic',
        points: 1200,
    ...
    },
    {
        ...
        description: 'Äáº¡t target 7 ngÃ y liÃªn tiáº¿p',
        icon: 'ðŸ”¥',
        category: 'streak',
        rarity: 'legendary',
        points: 2000,
    ...
    {
        id: 'ACCURACY_MASTER',
        title: 'Báº­c tháº§y chÃ­nh xÃ¡c',
        description: 'Duy trÃ¬ Ä‘á»™ chÃ­nh xÃ¡c 100% trong 30 ngÃ y',
        icon: 'ðŸŽ¯',
        category: 'accuracy',
        rarity: 'legendary',
        points: 2500,
